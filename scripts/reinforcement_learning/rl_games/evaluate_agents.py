...
parser.add_argument(
    ...
    type=str,
    default=None,
    help="Path to tournament directory containing config directories.",
)
parser.add_argument(
...
parser.add_argument(
    "--num_rounds", type=int, default=1, help="Number of rounds in the tournament."
)
parser.add_argument(
    "--num_games_per_round", type=int, default=5, help="Number of games per round."
)
parser.add_argument(
    "--tournament_name",
    type=str,
...
def main():
    ...
    if args_cli.elo_thresehold is None:
        ...
        dest_path = (
            source_path.parent.parent.parent / "best_agent"
        )  # go two levels up (to agent_X folder)
        ...
        shutil.copyfile(
            source_path,
            dest_path / f"best_agent({max_index + 1})_number_{args_cli.run_number}.pth",
        )
